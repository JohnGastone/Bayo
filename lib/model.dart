...
class PopularItemsModelList {
  static List<PopularItemsModel> getPopularItems = [
    PopularItemsModel(
      ...
      year: '2019',
      price: 650,
      brandPath: './assets/atletico-de-madrid.png',
      imagePath: './assets/at.png',
    ),
    PopularItemsModel(
      teamName: 'Barca',
      year: '2014',
      price: 300,
      brandPath: './assets/barcelona.png',
      imagePath: './assets/barca23.png',
    ),
    PopularItemsModel(
      teamName: 'Liverpool',
      year: '2019',
      price: 150,
      brandPath: './assets/lfc.png',
      imagePath: './assets/liv19.png',
    ),
    PopularItemsModel(
      teamName: 'Dortmund',
      year: '2022',
      price: 80,
      brandPath: './assets/bvblogo.png',
      imagePath: './assets/bvb.png',
    ),
  ];
